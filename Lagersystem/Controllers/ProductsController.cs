...
namespace Lagersystem.Controllers
{
    public class ProductsController : Controller
    {
        ...
        //Search with similar letters start with name
        public async Task<IActionResult> Search(string name)
        {
            var model = _context.Product
                .Where(prod => prod.Name.StartsWith(name))
                .Select(prod => new ProductViewModel
                {
                    ...
                    Price = prod.Price,
                    Count = prod.Count,
                    InventoryValue = prod.Count * prod.Price
                });


            return View(nameof(ProductsList), await model.ToListAsync());
        }

        // Get: listProducts
        public async Task<IActionResult> ProductsList()
        {
            var model = _context.Product.Select(prod => new ProductViewModel
            {
                Id = prod.Id,
                Name = prod.Name,
                Price = prod.Price,
